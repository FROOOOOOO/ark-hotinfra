...
def run_stress_test(output_path: str, node_num: int, run_cl2: bool = False):
    ...
    cmd_str = (f'source /home/ljy/miniconda3/bin/activate k8stest && python {python_path}/scripts/stress-test.py '
...
def run_reset_cp(wider_fc: bool = False):
    ...
    cmd_str = (f'source /home/ljy/miniconda3/bin/activate k8stest && '
