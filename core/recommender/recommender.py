...
from core.recommender import ga_optimizer, predictor
...
class Recommender:
    ...
    def __init__(
            ...
            baseline: str = 'ours', pred_model: str = 'latest', pred_calibration: bool = False,
        ...
        if baseline in ['p99', 'weighted', 'ours']:
    ...
    def _recommend(self):
        ...
        if self.baseline == 'ours':
            allocated, upcoming_kube_requests = self._recommend_ours()
            ...
            return
        if self.baseline == 'ours' and self.alloc_calibration and allocated:
